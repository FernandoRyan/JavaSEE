...
public class FASTFOOD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.getAccessibleContext().setAccessibleName("lblFastFood");
        jButton1.getAccessibleContext().setAccessibleName("btnBurger");
        jButton2.getAccessibleContext().setAccessibleName("btnSubmarine");
        jButton3.getAccessibleContext().setAccessibleName("btnHotDog");
        jButton4.getAccessibleContext().setAccessibleName("btnPizza");
        jButton5.getAccessibleContext().setAccessibleName("btnSandwitch");
        jButton6.getAccessibleContext().setAccessibleName("btnDonut");
        jLabel2.getAccessibleContext().setAccessibleName("lblCheeseBurger");
        jLabel3.getAccessibleContext().setAccessibleName("lblSubmarine");
        jLabel4.getAccessibleContext().setAccessibleName("lblHotDog");
        jLabel5.getAccessibleContext().setAccessibleName("lblPizza");
        jLabel6.getAccessibleContext().setAccessibleName("lblSandwitch");
        jLabel7.getAccessibleContext().setAccessibleName("lblDonut");
        jLabel8.getAccessibleContext().setAccessibleName("lblLKR");
        jLabel9.getAccessibleContext().setAccessibleName("lblLKR");
        jLabel10.getAccessibleContext().setAccessibleName("lblLKR");
        jLabel11.getAccessibleContext().setAccessibleName("lblLKR");
        jLabel12.getAccessibleContext().setAccessibleName("lblLKR");
        jLabel13.getAccessibleContext().setAccessibleName("lblLKR");
        jLabel14.getAccessibleContext().setAccessibleName("lblCheeseBurgerPrice");
        jLabel15.getAccessibleContext().setAccessibleName("lblSubmarinePrice");
        jLabel16.getAccessibleContext().setAccessibleName("lblHotDogPrice");
        jLabel17.getAccessibleContext().setAccessibleName("lblPizzaPrice");
        jLabel18.getAccessibleContext().setAccessibleName("lblSandwitchPrice");
        jLabel19.getAccessibleContext().setAccessibleName("lblDonutPrice");
        ...
        jPanel2.getAccessibleContext().setAccessibleName("pnlFastFood");
        jLabel23.getAccessibleContext().setAccessibleName("lnlTotalName");
        jLabel24.getAccessibleContext().setAccessibleName("lblLKR");
        jLabel25.getAccessibleContext().setAccessibleName("lblToatalPrice");
        jButton8.getAccessibleContext().setAccessibleName("btnCheckout");
        jLabel26.getAccessibleContext().setAccessibleName("LblMyPlate");
        jLabel27.getAccessibleContext().setAccessibleName("lblLogo");
        jButton9.getAccessibleContext().setAccessibleName("btnMEAL");
        jButton10.getAccessibleContext().setAccessibleName("btnFAST FOOD");
        jButton11.getAccessibleContext().setAccessibleName("btnAPPETIZERS");
        jButton12.getAccessibleContext().setAccessibleName("btnBEVERAGES");
